...
DOCUMENT_TYPES: dict[DocumentType, DocumentTypeInfo] = {
    ...
    DocumentType.BLIND_MEASUREMENTS: DocumentTypeInfo(identifier=DocumentType.BLIND_MEASUREMENTS, document_code="PRES.03.01", family=DocumentFamily.BUDGET, default_title="Mediciones ciegas", default_filename="PRES.03.01_Mediciones_Ciegas.xlsx"),
    DocumentType.MEASUREMENTS: DocumentTypeInfo(identifier=DocumentType.MEASUREMENTS, document_code="PRES.03.02", family=DocumentFamily.BUDGET, default_title="Mediciones", default_filename="PRES.03.02_Mediciones.xlsx"),
